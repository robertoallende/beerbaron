...
class Map1bis:
    def __init__(self, esc = 1):
        ...
        #definimos los nodos
        g.nodo("nodo1",0, 200*esc,  400*esc)
        g.nodo("nodo2",1, 200*esc,  201*esc)
        g.nodo("nodo3",2, 300*esc,  1*esc)
        g.nodo("nodo4",2, 200*esc,   1*esc)
        g.nodo("nodo5",2, 100*esc,  1*esc)
        #aristas
        g.arista("nodo1", "nodo2")
        g.arista("nodo2", "nodo3")
        g.arista("nodo2", "nodo4")
        g.arista("nodo2", "nodo5")
        g.packing()
        g.genPosMANUAL()
        self.nodos = g.nodos
        self.nodos_rdict = g.pack_dict #relacion de los nodos en diccionaro
